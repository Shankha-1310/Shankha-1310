...
the kind of work that actually keeps systems safe.
...
- Building a home SOC lab with Splunk to detect brute-force 
  and lateral movement
- Phishing email analysis portfolio with IOC documentation
